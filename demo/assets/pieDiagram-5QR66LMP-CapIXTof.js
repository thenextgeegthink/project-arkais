import{H as e,U as t,a as n,c as r,f as i,q as a,v as o,w as s,x as c,y as l}from"./chunk-O7XYJQB3-BLAEZ_ee.js";import{n as u}from"./chunk-Y2CYZVJY-DsF7k-Jl.js";import{n as d}from"./src-DHCbXJcT.js";import{n as f}from"./ordinal-BdBDtYTt.js";import{n as p}from"./path-B_0haWDX.js";import{p as m}from"./math-Bi_r_ZWc.js";import{t as h}from"./arc-BG5fwuvK.js";import{t as g}from"./array-BifhSqXX.js";import{i as _,p as v}from"./chunk-ZIGJFQKS-HuVvgoCe.js";import{y}from"./index-th1B0Zqh.js";import{n as b}from"./mermaid-parser.core-CEhpNPKV.js";import{t as x}from"./chunk-JWPE2WC7-DVXcaiue.js";function S(e,t){return t<e?-1:t>e?1:t>=e?0:NaN}function C(e){return e}function w(){var e=C,t=S,n=null,r=p(0),i=p(m),a=p(0);function o(o){var s,c=(o=g(o)).length,l,u,d=0,f=Array(c),p=Array(c),h=+r.apply(this,arguments),_=Math.min(m,Math.max(-m,i.apply(this,arguments)-h)),v,y=Math.min(Math.abs(_)/c,a.apply(this,arguments)),b=y*(_<0?-1:1),x;for(s=0;s<c;++s)(x=p[f[s]=s]=+e(o[s],s,o))>0&&(d+=x);for(t==null?n!=null&&f.sort(function(e,t){return n(o[e],o[t])}):f.sort(function(e,n){return t(p[e],p[n])}),s=0,u=d?(_-c*b)/d:0;s<c;++s,h=v)l=f[s],x=p[l],v=h+(x>0?x*u:0)+b,p[l]={data:o[l],index:s,value:x,startAngle:h,endAngle:v,padAngle:y};return p}return o.value=function(t){return arguments.length?(e=typeof t==`function`?t:p(+t),o):e},o.sortValues=function(e){return arguments.length?(t=e,n=null,o):t},o.sort=function(e){return arguments.length?(n=e,t=null,o):n},o.startAngle=function(e){return arguments.length?(r=typeof e==`function`?e:p(+e),o):r},o.endAngle=function(e){return arguments.length?(i=typeof e==`function`?e:p(+e),o):i},o.padAngle=function(e){return arguments.length?(a=typeof e==`function`?e:p(+e),o):a},o}var T=i.pie,E={sections:new Map,showData:!1,config:T},D=E.sections,O=E.showData,k=structuredClone(T),A={getConfig:u(()=>structuredClone(k),`getConfig`),clear:u(()=>{D=new Map,O=E.showData,n()},`clear`),setDiagramTitle:a,getDiagramTitle:s,setAccTitle:t,getAccTitle:l,setAccDescription:e,getAccDescription:o,addSection:u(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);D.has(e)||(D.set(e,t),d.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:u(()=>D,`getSections`),setShowData:u(e=>{O=e},`setShowData`),getShowData:u(()=>O,`getShowData`)},j=u((e,t)=>{x(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),M={parse:u(async e=>{let t=await b(`pie`,e);d.debug(t),j(t,A)},`parse`)},N=u(e=>`
  .pieCircle{
